...
async function fetchParameters(executionContext) {
    ...
    try {
        ...
        await callSynexusAndUpdateLines(formContext, cfg, invoiceId, invoiceLines);
...
async function callSynexusAndUpdateLines(formContext, cfg, invoiceId, invoiceLines) {
